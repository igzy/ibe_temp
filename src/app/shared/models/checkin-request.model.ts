...
import { TIER, AIRLINE_ID_KEY, LANGUAGE_KEY, DEVICE_TYPE_MOBILE, DEVICE_TYPE_WEB, E_RETAIL_APPLICATION, CHECKIN_MODULES,
    MARKET_CODE_KEY } from '../../configs/app-settings.config';
...
export class CheckinBookingNumberRequest {
